...
public class ImageBean {
    ...
    private PageBeanBeanHeadline pageBean;
    private String status;
    private List<ItemsBeanHeadline> items;

    public PageBeanBeanHeadline getPageBean() {
        return pageBean;
    }

    public void setPageBean(PageBeanBeanHeadline pageBean) {
    ...
    public static class PageBeanBeanHeadline {
        /**
         * size : 20
         * total : 0
         * count : 0
